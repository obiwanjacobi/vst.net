...
#pragma warning disable S3963 // "static" fields should be initialized inline
        static PluginComWrappers()
        {
            ...
            vtable[idx++] = (IntPtr)(delegate* unmanaged<IntPtr, ref Guid, ref Guid, IntPtr, Int32>)&ABI.IPluginFactoryManagedWrapper.CreateInstance;
...
namespace ABI
{
    ...
    unsafe internal static class IPluginFactoryManagedWrapper
    {
        ...
        public static Int32 GetFactoryInfo(IntPtr self, IntPtr* infoPtr)
        {
            var instance = ComInterfaceDispatch.GetInstance<IPluginFactory>((ComInterfaceDispatch*)self);

            PFactoryInfo factoryInfo = new PFactoryInfo();
            var result = instance.GetFactoryInfo(ref factoryInfo);

            *infoPtr = Marshal.AllocHGlobal(Marshal.SizeOf(factoryInfo));
            Marshal.StructureToPtr(factoryInfo, *infoPtr, fDeleteOld: false);

            return result;
        }

        [UnmanagedCallersOnly]
        public static Int32 CountClasses(IntPtr self)
        {
            return 0;
        }

        [UnmanagedCallersOnly]
        public static Int32 GetClassInfo(IntPtr self, Int32 index, IntPtr info)
        {
            return TResult.S_OK;
        }

        [UnmanagedCallersOnly]
        public static Int32 CreateInstance(IntPtr self, ref Guid classId, ref Guid interfaceId, IntPtr instance)
        {
            return TResult.S_OK;
        }
    }
