...
namespace Jacobi.Vst3.Interop
{
    ...
    public interface IAudioProcessor
    {
        ...
        Int32 SetBusArrangements([MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1), In] SpeakerArrangement[] inputs, [MarshalAs(UnmanagedType.I4), In] Int32 numIns,
                                 [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3), In] SpeakerArrangement[] outputs, [MarshalAs(UnmanagedType.I4), In] Int32 numOuts);
