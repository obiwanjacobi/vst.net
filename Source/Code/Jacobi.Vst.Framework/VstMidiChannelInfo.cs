...
using System.ComponentModel;
    ...
    public class VstMidiChannelInfo : ObservableObject
    {
        ...
        public bool HasChanged
        {
            ...
            set
            {
                SetProperty(value, ref _hasChanged, HasChangedPropertyName);
            }
        }
        ...
        private class CollectionChangeManager<ItemT> : IDisposable
        {
            private INotifyCollectionChanged _collection;
            private Action<ItemT> _addItemHandler;
            private Action<ItemT> _removeItemHandler;
