...
namespace Jacobi.Vst.StereoMelter
{
    ...
    internal sealed class Plugin : VstPluginWithInterfaceManagerBase
    {
        ...
        /// </summary>
        private static readonly int UniquePluginId = new FourCharacterCode("VNS1").ToInt32();
        /// <summary>
        /// TODO: assign a plugin name.
        /// </summary>
        private const string PluginName = "Stereo Melter";
        /// <summary>
        /// TODO: assign a product name.
        /// </summary>
        private const string ProductName = "VST.NET";
        /// <summary>
        /// TODO: assign a vendor name.
        /// </summary>
        private const string VendorName = "Jacobi Software";
        /// <summary>
